  ...
  return (
    <section className="py-24 bg-secondary">
      <div className="max-w-3xl mx-auto px-8">
        <div className="bg-card rounded-3xl shadow-lg border border-border p-10 md:p-12">
          <div className="flex justify-center mb-6">
            <span className="inline-block bg-primary/10 text-primary text-xs font-bold uppercase tracking-wider px-4 py-1.5 rounded-full">
              Backed by Research
            </span>
          </div>
          ...
          <p className="text-xs font-bold uppercase tracking-wider text-muted-foreground text-center mb-5">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {benefits.map((b, i) => (
              <div
                key={i}
                className="flex items-center gap-2 bg-secondary rounded-full px-4 py-2.5 text-sm font-medium text-foreground"
              >
